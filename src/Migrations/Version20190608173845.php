 ...
 */
final class Version20190608173845 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, album_id INT DEFAULT NULL, utilisateur_id INT NOT NULL, libelle VARCHAR(255) NOT NULL, texte LONGTEXT NOT NULL, lien_youtube VARCHAR(255) DEFAULT NULL, date_creation DATETIME NOT NULL, no_kill TINYINT(1) NOT NULL, INDEX IDX_23A0E661137ABCF (album_id), INDEX IDX_23A0E66FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE picture (id INT AUTO_INCREMENT NOT NULL, article_id INT NOT NULL, photo VARCHAR(255) NOT NULL, INDEX IDX_16DB4F897294869C (article_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
